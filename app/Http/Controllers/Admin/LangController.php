...
class LangController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ConfigLang::update_config($lang->id, 'site_label', $request->site_label ?? 'Clevada Site');        
    ...
    public function update(Request $request)
    {
        ...
        ConfigLang::update_config($request->id, 'site_label', $request->site_label ?? 'Clevada Site');        
