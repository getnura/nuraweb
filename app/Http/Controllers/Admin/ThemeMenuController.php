...
class ThemeMenuController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        ThemeMenu::where('id', $request->id)->update(['label' => $request->label, 'type' => $type, 'value' => $value ?? null, 'new_tab' => $new_tab, 'css_class' => $request->css_class ?? null, 'icon' => $request->icon]);
    ...
    public function update_dropdown(Request $request)
    {
        ...
        */
        ...
        ThemeMenu::where('id', $link_id)->update(['type' => $type, 'label' => $request->label, 'value' => $value ?? null, 'new_tab' => $new_tab, 'icon' => $request->icon]);
