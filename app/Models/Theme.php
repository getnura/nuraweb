...
class Theme extends Model
{
    ...
    public static function generate_styles_css()
    {
        ...
        foreach ($styles as $style) {
            // 2. FONTS AND COLORS
            $font_color = $style->text_color ?? config('clevada.defaults.font_color');
            ...
            if ($style->bg_color) {
                $bg_color = $style->bg_color ?? config('clevada.defaults.bg_color');
                $write = ".style_$style->id { background-color: $bg_color!important; } ";
                fwrite($css_file, $write);
            }

            // 3. LINKS            
            $link_color = $style->link_color ?? config('clevada.defaults.link_color');
            $link_color_hover = $style->link_hover_color ?? config('clevada.defaults.link_color_hover');
            $link_color_underline = $style->link_color_underline ?? config('clevada.defaults.link_color_underline');
            $link_underline_offset = $style->link_underline_offset ?? 'auto';
            $link_underline_thickness = $style->link_underline_thickness ?? 'auto';
            $link_underline_color = $style->link_underline_color ?? config('clevada.defaults.link_color_underline');
            $link_underline_color_hover = $style->link_underline_color_hover ?? config('clevada.defaults.link_color_underline_hover');

            $link_decoration = $style->link_decoration ?? config('clevada.defaults.link_decoration');
            $link_hover_decoration = $style->link_hover_decoration ?? config('clevada.defaults.link_hover_decoration');
            $link_underline_offset = $style->link_underline_offset ?? config('clevada.defaults.link_hover_decoration');
        ...
        foreach ($buttons as $button) {
            $bg_color = $button->bg_color ?? config('clevada.defaults.button_bg_color');
            $font_color = $button->font_color ?? config('clevada.defaults.button_font_color');
            $font_weight = $button->font_weight ?? 'normal';
            $rounded = $button->rounded ?? 0;
            $border_color = $button->border_color ?? config('clevada.defaults.button_border_color');
            $bg_color_hover = $button->bg_color_hover ?? config('clevada.defaults.button_bg_color_hover');
            $font_color_hover = $button->font_color_hover ?? config('clevada.defaults.button_font_color_hover');
            $border_color_hover = $button->border_color_hover ?? config('clevada.defaults.button_border_color_hover');
