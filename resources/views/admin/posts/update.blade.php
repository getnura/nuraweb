            ...
            <div class="col-12">
                ...
                <div class="float-end">
                    @if ($post->status == 'published')
                        <a target="_blank" href="{{ post($post->id)->url }}" class="btn btn-sm btn-secondary"><i class="bi bi-box-arrow-up-right"></i>
                            {{ __('Preview') }}</a>
                    @endif
                </div>
                    ...
                    <div class="p-3 bg-light mb-3">
                        ...
                        <div class="form-group">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="checkbox_featured" name="featured" @if ($post->featured == 1) checked @endif>
                                <label class="form-check-label" for="checkbox_featured">{{ __('Featured') }}</label>
                            </div>
                            <div class="small text-muted">{{ __('Featured posts are displayed first') }}</div>
                        </div>   
