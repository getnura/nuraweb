...
@if (($config->module_posts ?? null) == 'disabled')
    <div class="alert alert-danger">
        {{ __('Posts module is disabled.') }} <a href="{{ route('admin.config', ['module' => 'general']) }}">{{ __('Manage modules') }}</a>
    </div>
@else
    <div class="card">
        ...
        <div class="card-header">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-6 order-md-1 order-first">
                    ...
                    <div class="card-title">{{ __('Posts') }} ({{ $posts->total() ?? 0 }} {{ __('posts') }})</div>
                </div>
        ...
        <div class="card-body">
            ...
            <section>
                <form action="{{ route('admin.posts.index') }}" method="get" class="row row-cols-lg-auto g-3 align-items-center">
                    ...
                    <div class="col-12">
                        <input type="text" name="search_terms" placeholder="{{ __('Search in posts') }}" class="form-control me-2 mb-2 @if ($search_terms) is-valid @endif"
                            value="<?= $search_terms ?>" />
                    </div>
