    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br>
                <i class="bi bi-dot"></i> {{ __('The first administrator is the website owner. Only the owner can delete other admin accounts.') }}

                <div class="fw-bold mb-1 mt-3">{{ __('Manager') }}</div>
                <i class="bi bi-dot"></i>
                {{ __('Managers have full access (create / update / delete) to all site content, including plugins content (manage any post from any author, manage categories, manage likes and comments, static pages, contact messages...).') }}
                <br>
                <i class="bi bi-dot"></i>
                ...
                <i class="bi bi-dot"></i>
                {{ __('Developers have access to manage the website template (change template, edit templates) and plugins section (install plugins, manage plugins content). This is useful when the administrator does not have the knowledge to work with the templates and wants to transfer access to an external developer to create the site template.') }}
                ...
                <i class="bi bi-dot"></i> {{ __('By default, registered users can add comments to website articles.') }}
                <br>
                <i class="bi bi-dot"></i>
                {{ __('Registered users may have custom permissions depending on the plugins. For example, with an e-commerce plugin, registered users are customers and can buy products. For a community plugin, registered users can create topics. And so on...') }}
            </div>
