            ...
            <form method="post" enctype="multipart/form-data" id="createAccountForm">
                ...
                <div class="modal-body pt-0">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-text">{{ __('Must be a valid email address.') }}</div>
                    </div>
                    ...
                    <div class="row">                                            
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-label">{{ __('Username') }} ({{ __('required') }})</label>
                                <input class="form-control" name="username" type="text" required minlength="2" maxlength="100" />
                                <div class="form-text">{{ __('Lowercases. Spaces are converted to "-". Special characters are removed. Must be unique') }}</div>
                            </div>
                        </div>
