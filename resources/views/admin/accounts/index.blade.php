                ...
                <div class="float-end">
                    ...
                    <div class="dropdown float-end ms-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton" style="min-width: 200px;">
                            ...
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#create-account">{{ __('Manually create') }}</a></li>
                        </ul>
                    </div>
            ...
            <form action="{{ route('admin.accounts.index') }}" method="get" class="row row-cols-lg-auto g-3 align-items-center">
                ...
                <div class="col-12">
                    <select name="search_blocked" class="form-select @if ($search_blocked) is-valid @endif">
                        ...
                        <option @if ($search_blocked == 'no') selected @endif value="no"> {{ __('Active accounts') }}</option>
                        <option @if ($search_blocked == 'yes') selected @endif value="yes"> {{ __('Blocked accounts') }}</option>
                    </select>
                </div>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="fw-bold mb-2 fs-5">
                                    <a href="{{ route('admin.accounts.show', ['id' => $account->id]) }}">{{ $account->name }} ({{ $account->username }})</a>
                            ...
                            <td>
                                ...
                                @if ($account->is_owner)
                                    <div class="badge bg-success fw-bold text-white">{{ __('Owner') }}</div>
                                @endif
                            </td>
