            ...
            <div class="col-12 col-sm-12 col-md-6 order-md-2 order-last">
                @if (Auth::user()->role == 'admin')
                    <div class="float-end">
                        ...
                        <a href="{{ route('admin.config', ['module' => 'contact']) }}" class="btn btn-primary ms-1"><i class="bi bi-gear"></i> {{ __('Contact page settings') }}</a>
                        <a href="{{ route('admin.contact.trash') }}" class="btn btn-secondary ms-1"><i class="bi bi-trash"></i> {{ __('Trash') }}</a>
                    </div>
                @endif
            </div>
