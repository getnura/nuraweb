        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="breadcrumb-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.theme.menu') }}">{{ __('Menu links') }}</a></li>
                        ...
                        <tr id="item-{{ $link->id }}">
                            ...
                            <td>
                                <div class="d-grid gap-2">
                                    ...
                                    @include('admin.theme.modals.update-menu-link-dropdown')
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form method="POST" action="{{ route('admin.theme.menu.dropdown', ['id' => $link->id, 'parent_id' => $parent_link->id ?? null]) }}">
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE') }}
        ...
        $("#sortable").sortable({
            ...
            update: function(event, ui) {
                ...
                $.ajax({
                    data: data,
                    type: "POST",
                    url: "{{ route('admin.theme.menu.sortable_dropdowns', ['parent_link_id' => $parent_link->id]) }}",
                });
            }
        });
