        ...
        <div class="card-body">
            ...
            <form method="post">
                ...
                <div class="row">
                    <div class="col-12 col-lg-3 col-md-4">
                        <div class="form-group mb-4">
                            <input id="bg_color" name="bg_color" value="{{ $button->bg_color ?? config('nura.defaults.button_bg_color') }}">
                            <label>{{ __('Background color') }}</label>
                            <div class="mt-1 small"> {{ strtoupper($button->bg_color) ?? config('nura.defaults.button_bg_color') }}</div>
                            <script>
                                $('#bg_color').spectrum({
                                    type: "color",
                                    showInput: true,
                    ...
                    <div class="col-12 col-lg-3 col-md-4">
                        <div class="form-group mb-4">
                            <input id="font_color" name="font_color" value="{{ $button->font_color ?? config('nura.defaults.button_font_color') }}">
