...
<div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="updateLabel-{{ $link->id }}" aria-hidden="true" id="update-menu-link-{{ $link->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.theme.menu.show', ['id' => $link->id]) }}" method="post">
                @csrf
                @method('PUT')
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-check-label">{{ __('CSS class') }} ({{ __('optional') }})</label>
                                <input class="form-control" name="css_class" value="{{ $link->css_class }}">
                            </div>
                        </div>
                    </div>
