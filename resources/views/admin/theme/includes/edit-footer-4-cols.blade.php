        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="builder-col sortable" id="sortable_1">
                <div class="mb-4 text-center">
                    ...
                    @include('admin.theme.modals.add-footer-block', ['col' => 1])
                </div>
                ...
                @foreach (footer_blocks($footer, $col = 1, $show_hidden = true) as $block)
                    <div class="builder-block movable" id="item-{{ $block->id }}">
                        <div class="float-end ms-2">
                            ...
                            <a href="{{ route('admin.themes.footer.block', ['id' => $block->id]) }}" class="btn btn-primary btn-sm">{{ __('Manage content') }}</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form method="POST" action="{{ route('admin.themes.footer.content.delete', ['footer' => $footer, 'block_id' => $block->id]) }}">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
            ...
            <div class="builder-col sortable" id="sortable_2">
                <div class="mb-4 text-center">
                    <a class="btn btn-danger" href="#" data-bs-toggle="modal" data-bs-target="#addBlock2"><i class="bi bi-plus-circle"></i>
                        {{ __('Add content block') }}</a>
                    @include('admin.theme.modals.add-footer-block', ['col' => 2])
                </div>
            ...
            <div class="builder-col sortable" id="sortable_3">
                <div class="mb-4 text-center">
                    <a class="btn btn-danger" href="#" data-bs-toggle="modal" data-bs-target="#addBlock3"><i class="bi bi-plus-circle"></i>
                        {{ __('Add content block') }}</a>
                    @include('admin.theme.modals.add-footer-block', ['col' => 3])
                </div>
            ...
            <div class="builder-col sortable" id="sortable_4">
                <div class="mb-4 text-center">
                    <a class="btn btn-danger" href="#" data-bs-toggle="modal" data-bs-target="#addBlock4"><i class="bi bi-plus-circle"></i>
                        {{ __('Add content block') }}</a>
                    @include('admin.theme.modals.add-footer-block', ['col' => 4])
                </div>
            ...
            $("#sortable_1").sortable({
                ...
                update: function(event, ui) {
                    ...
                    $.ajax({
                        data: data,
                        type: 'POST',
                        url: "{{ route('admin.themes.footer.sortable', ['footer' => $footer, 'col' => 1]) }}",
                    });
                }
            });
            ...
            $("#sortable_2").sortable({
                ...
                update: function(event, ui) {
                    ...
                    $.ajax({
                        data: data,
                        type: 'POST',
                        url: "{{ route('admin.themes.footer.sortable', ['footer' => $footer, 'col' => 2]) }}",
                    });
                }
            });
            ...
            $("#sortable_3").sortable({
                ...
                update: function(event, ui) {
                    ...
                    $.ajax({
                        data: data,
                        type: 'POST',
                        url: "{{ route('admin.themes.footer.sortable', ['footer' => $footer, 'col' => 3]) }}",
                    });
                }
            });
            ...
            $("#sortable_4").sortable({
                ...
                update: function(event, ui) {
                    ...
                    $.ajax({
                        data: data,
                        type: 'POST',
                        url: "{{ route('admin.themes.footer.sortable', ['footer' => $footer, 'col' => 4]) }}",
                    });
                }
            });
